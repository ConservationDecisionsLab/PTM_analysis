...
It requires output from *standardizeConfidence.R*, which standardizes the individual estimates to 80% confidence level and saves results as **Standardized\_Estimates\_Long.csv**
